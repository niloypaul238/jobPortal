...
import FollowBtn from '@/app/Component/FollowBtn';
        ...
        <div className='w-10/12 mx-auto'>
            <div className='bg-gray-200 flex  justify-between p-10'>
                <div className='flex gap-x-6'>
                    <Image alt='logo' className='rounded-xl' src={'https://plus.unsplash.com/premium_vector-1689096806777-4a8b03b07dca?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8bG9nbyUyMGRlc2lnbnxlbnwwfHwwfHx8MA%3D%3D'} width={120} height={120} />
                    <div className='space-y-2'>
                        <h1 className='text-2xl'><span className={jost.className}>Mukianso IT Sulution Ltd.</span></h1>
                        <p className='flex items-center gap-4 text-gray-500 text-sm'>
                            <span className='flex gap-x-1 items-center'><MapPin size={15} />Chittagong, Bangladesh</span>
                ...
                <div className='flex justify-between gap-x-3'>
                    <div className='flex relative overflow-hidden z-0 flex-col group justify-center items-center transition-all duration-300 rounded-xl   px-4 bg-white'>
                        ...
                        <p className='text-4xl group-hover:text-white'><span className={jost.className}>83</span></p>
                    ...
                    <div className='flex relative overflow-hidden z-0 flex-col group justify-center items-center transition-all duration-300 rounded-xl   px-4 bg-white'>
                        <span className="bg-green-600 absolute  -z-1 w-full h-full left-0 group-hover:top-0 transition-all top-full duration-300"></span>
                        <p className='text-4xl group-hover:text-white'>533</p>
                        ...
                        <div className="bg-gray-100 p-6 rounded-lg h-fit">
                            ...
                            <div className="space-y-2 ">
                                ...
                                <div className="grid grid-cols-12">
                                    ...
                                    <span>:</span>
                                    <span className=" whitespace-nowrap col-span-5">Design & Software</span>
                                </div>
                                <div className="grid grid-cols-12">
                                    <span className='col-span-5'>Since</span>
                                    <span>:</span>
                                    <span className="  whitespace-nowrap col-span-5">1996</span>
                                </div>
                                <div className="grid grid-cols-12">
                                ...
                                <div className="grid grid-cols-12">
                                    ...
                                    <span>:</span>
                                    <span className=" whitespace-nowrap col-span-5">68+</span>
                                </div>
                                <div className="grid grid-cols-12">
                                    <span className='col-span-5'>Location</span>
                                    <span>:</span>
                                    <span className=" whitespace-nowrap col-span-5">New York, Chittagong</span>
                                </div>
                                <div className="grid grid-cols-12">
                                ...
                                <div className="grid grid-cols-12">
                                    ...
                                    <span>:</span>
                                    <span className=" whitespace-nowrap col-span-5">yourmail@gmail.com</span>
                                </div>
